...
public class Article {
    ...
    public Article(Long articleId, LocalDateTime auctionStartDate, LocalDateTime auctionEndDate, String description, Float reservePrice, Double hammerPrice, Customer seller, Customer buyer, ArticleStatus articleStatus) {
        this.id = articleId;
